...
assert_ok examples/simulations/simple_netcdf.josh || exit 30
assert_ok examples/simulations/state.josh || exit 31
assert_ok examples/simulations/variables.josh || exit 32
