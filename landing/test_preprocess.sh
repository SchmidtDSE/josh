...
java -jar joshsim-fat.jar run --replicates=1 ../examples/test/assert_temperature_tulare.josh AssertTemperatureTulare
if [ $? -eq 0 ]; then
...
java -jar joshsim-fat.jar run --replicates=1 ../examples/test/assert_precipitation_tulare.josh AssertPrecipitationTulare
if [ $? -eq 0 ]; then
...
java -jar joshsim-fat.jar run --replicates=1 ../examples/test/assert_precipitation_geotiff.josh AssertPrecipitationGeotiff
if [ $? -eq 0 ]; then
