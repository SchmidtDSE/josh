...
public class GeometryTest {
  ...
  class PointGeometryTests {
    ...
    public void testGetCenterCoordinates() {
      assertEquals(
          ...
          pointGeometry.getCenterLatitude(),
          "Center latitude should match the point's Y coordinate");
      assertEquals(
          BigDecimal.valueOf(10.0),
          pointGeometry.getCenterLongitude(),
    ...
    public void testPointIntersectsWithItself() {
      assertTrue(
          pointGeometry.intersects(BigDecimal.valueOf(20.0), BigDecimal.valueOf(10.0)),
    ...
    public void testPointDoesNotIntersectWithDistantPoint() {
      assertFalse(
          pointGeometry.intersects(BigDecimal.valueOf(30.0), BigDecimal.valueOf(40.0)),
  ...
  class RectangleGeometryTests {
    ...
    public void testRectangleContainsPoint() {
      ...
      assertTrue(
          rectangleGeometry.intersects(BigDecimal.valueOf(21.0), BigDecimal.valueOf(11.0)),
          "Rectangle should contain point inside its bounds");

      // Point on rectangle boundary
      assertTrue(
          rectangleGeometry.intersects(BigDecimal.valueOf(20.0), BigDecimal.valueOf(10.0)),
          "Rectangle should contain point on its boundary");

      // Point outside rectangle
      assertFalse(
          rectangleGeometry.intersects(BigDecimal.valueOf(30.0), BigDecimal.valueOf(40.0)),
    ...
    public void testRectangleIntersectsWithGeometry() {
      ...
      assertTrue(
          rectangleGeometry.intersects(insideGeometry),
      ...
      assertTrue(
          rectangleGeometry.intersects(overlappingGeometry),
      ...
      assertFalse(
          rectangleGeometry.intersects(nonOverlappingGeometry),
  ...
  class CircleGeometryTests {
    ...
    public void testGetCenterCoordinates() {
      assertEquals(
          BigDecimal.valueOf(20.0),
          circleGeometry.getCenterLatitude(),
          "Center latitude should match the circle's center Y");
      assertEquals(
          BigDecimal.valueOf(10.0),
          circleGeometry.getCenterLongitude(),
    ...
    public void testCircleContainsPoint() {
      ...
      assertTrue(
          circleGeometry.intersects(BigDecimal.valueOf(20.0), BigDecimal.valueOf(10.0)),
          "Circle should contain its center point");

      // Point inside circle
      assertTrue(
          circleGeometry.intersects(BigDecimal.valueOf(20.5), BigDecimal.valueOf(10.5)),
          "Circle should contain point inside its radius");

      // Point outside circle
      assertFalse(
          circleGeometry.intersects(BigDecimal.valueOf(25.0), BigDecimal.valueOf(15.0)),
    ...
    public void testCircleIntersectsWithGeometry() {
      ...
      Geometry insideGeometry = new Geometry(insidePoint);
      assertTrue(
          circleGeometry.intersects(insideGeometry),
      ...
      assertTrue(
          circleGeometry.intersects(overlappingGeometry),
      ...
      assertFalse(
          circleGeometry.intersects(nonOverlappingGeometry),
