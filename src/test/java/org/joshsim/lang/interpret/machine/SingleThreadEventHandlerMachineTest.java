...
public class SingleThreadEventHandlerMachineTest {
  ...
  @Test
  void condition_shouldReturnTrueForPositiveValue() {
    // Given
    ...
    // Then
    assertEquals(new BooleanScalar(null, true, Units.EMPTY), machine.getResult());
  }

  @Test
  void condition_shouldReturnFalseForZeroValue() {
    // Given
    EngineValue value = new IntScalar(null, 0L, Units.EMPTY);
    ...
    // Then
    assertEquals(new BooleanScalar(null, false, Units.EMPTY), machine.getResult());
  }

  @Test
  void branch_shouldSelectFirstValueWhenConditionIsTrue() {
    // Given
    EngineValue condition = new BooleanScalar(null, true, Units.EMPTY);
    EngineValue trueValue = new IntScalar(null, 1L, Units.EMPTY);
    EngineValue falseValue = new IntScalar(null, 2L, Units.EMPTY);

    // When
    machine.push(condition);
    machine.push(trueValue);
    machine.push(falseValue);
    machine.branch();
  ...
  @Test
  void branch_shouldSelectSecondValueWhenConditionIsFalse() {
    // Given
    ...
    // Then
    assertEquals(new IntScalar(null, 2L, Units.EMPTY), machine.getResult());
  }
