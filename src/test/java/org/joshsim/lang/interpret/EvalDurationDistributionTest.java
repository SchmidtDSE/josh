...
public class EvalDurationDistributionTest {
   ...
   *
   * <p>Previously this failed because the resolver wrapped the intermediate scalar distribution
   * in a DistributionScope whose constructor called getAsEntity() on scalars. The fix in
   * DistributionScope.has() now routes the dotted path correctly.</p>
   */
  @Test
