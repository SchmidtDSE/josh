...
public interface Distribution extends EngineValue {
   ...
   *
   * <p>
   * Sample repeatedly from this distribution given a number of samples to retrieve. In each sampling
   * this draw can either happen with or without replacement. With replacement, each value has a
   * probability of selection proportional to the frequency of that value. Without replacement,
   * each value has a probability of selection proprotion to the frequency of that value minus the
   * number of times it was drawn in this invocation of getContents.
   * </p>
   *
