...
public class IntScalar extends Scalar {
  ...
  // that we only need to implement each operation once. Each type of scalar needs to know how to
  // perform
  ...
  // SECOND DISPATCH
  // These methods are called by the first dispatch methods, and are implemented in each subclass of
  // Scalar. We
