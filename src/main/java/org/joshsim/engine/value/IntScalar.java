...
public class IntScalar extends Scalar {
  ...
  /**
   * Compares this IntScalar with the specified IntScalar.
   *
   * @param other the other IntScalar to be compared.
   * @return A negative integer if this is less than other, zero if equal, and positive integer
   *     otherwise.
   */
  ...
  /* Compares this DecimalScalar with the specified IntScalar.
   *
   * @param other the other DecimalScalar to be compared.
   * @return A negative integer if this is less than other, zero if equal, and positive integer
   *     otherwise.
   */
