 ...
 *
 * <p>A distribution which is described by parameters to define a certain mathematical shape but which
 * does not have specific individual elements. These distributions can still be sampled and used
