 ...
 * 
 * <p>Represents a compiled callable that can be evaluated to produce a value. This is the foundation
 * for functions, operators, and expressions in the Josh language and simulation engine. These may
 * be created through Josh DSL code.
 * </p>
 */
